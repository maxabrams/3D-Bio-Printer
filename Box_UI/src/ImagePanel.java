...
public class ImagePanel {
	...
	public ImagePanel() {
		...
		statusButton.addActionListener(new ActionListener() { // Add action
																// listener to
																// respond to
																// button

					public void actionPerformed(ActionEvent e) {
						System.out.println("Checking system status!"); // Example
																		// action
		...
		JLabel duration = new JLabel(
				"Total time of Experiment (hours |minutes)");
		...
		layout.setHorizontalGroup(layout
				...
				.addGroup(
						layout.createParallelGroup(
								...
								.addComponent(capture).addComponent(duration))
				.addGroup(
						layout.createParallelGroup(
								GroupLayout.Alignment.LEADING)
								.addComponent(title)
